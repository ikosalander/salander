...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Nous sommes une agence web.", "Créateur de bonheur.", "Toujours avec passion."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            {
            address: "Lille",
            html: "<b>Addresse</b>: <br> 84 rue de Trevisse, 59000 Lille France", 
            popup: true
            }
            ]
            });
